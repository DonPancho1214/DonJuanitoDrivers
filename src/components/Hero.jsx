      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        <div className="max-w-2xl xl:max-w-3xl">
          ...
          <div className="flex flex-wrap gap-4 mb-12 animate-fade-in-up" style={{ animationDelay: '0.4s', opacity: 0 }}>
            <a href="#agendar" className="btn-yellow px-6 py-3 font-bold text-base rounded-lg flex items-center gap-2 shadow-md">
            ...
            <button
              ...
              className="border-2 border-gray-900 bg-white text-gray-900 px-6 py-3 font-bold text-base rounded-lg hover:bg-gray-900 hover:text-white transition-colors flex items-center gap-2 shadow-sm"
            >
