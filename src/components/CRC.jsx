...
export default function CRC() {
  return (
    <section id="crc" className="py-24 relative overflow-hidden" style={{ background: 'rgba(255,255,255,0.7)' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="glass-card p-8 relative overflow-hidden shadow-sm">
            ...
            <div className="flex flex-col gap-4 mb-6">
              ...
              <div className="p-3.5 rounded-xl" style={{ background: '#f9fafb', border: '1px solid #e5e7eb' }}>
                <div className="text-gray-500 text-xs uppercase tracking-wider mb-2 font-semibold">Horarios de atención</div>
                <div className="flex flex-col gap-1 font-medium">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-gray-400">No abre</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className="btn-yellow w-full justify-center rounded-lg shadow-md"
            >
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* Process steps */}
            <div className="glass-card p-6 mt-2 shadow-sm" style={{ border: '1px solid #e5e7eb' }}>
              <h4 className="font-bold text-gray-900 mb-4" style={{ fontFamily: 'Barlow Condensed', fontSize: '1.1rem' }}>
                ¿Cómo funciona?
              </h4>
              {[
                ...
                <div key={step.n} className="flex items-start gap-3 mb-3 last:mb-0">
                  ...
                  <div>
                    <div className="text-gray-900 text-sm font-bold">{step.t}</div>
